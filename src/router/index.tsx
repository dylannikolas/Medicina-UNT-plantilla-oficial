...
const OrganosGobierno = lazy(
  () => import("../pages/organizacion/OrganosGobierno"),
); // consejo de facultad + consejeros + representantes
...
const Publicaciones = lazy(
  () => import("../pages/investigacion/Publicaciones"),
);
const ProyectosGrupo = lazy(
  () => import("../pages/investigacion/ProyectosGrupo"),
); // proyectos + tesis
...
const ResponsabilidadSocial = lazy(
  () => import("../pages/academico/ResponsabilidadSocial"),
);
...
const Administrativos = lazy(
  () => import("../pages/autoridades/Administrativos"),
...
const GestionFormacionPregrado = lazy(
  () => import("../pages/admision/GestionFormacionPregrado"),
);
          ...
          <Suspense fallback={<RouteFallback />}>
            <Routes>
              ...
              <Route path="/academico" element={<AcademicoIndex />}>
                ...
                <Route
                  path="laboratorios"
                  element={<EnConstruccion titulo="Laboratorios" />}
                />
                <Route
              ...
              <Route path="/investigacion" element={<InvestigacionIndex />}>
                ...
                <Route
                  path="revistas"
                  element={<EnConstruccion titulo="Revistas" />}
                />
              ...
              <Route
                path="/admision/gestion-formacion-pregrado"
                element={<GestionFormacionPregrado />}
              />
