...
export default function FloatingSocials() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 transform-gpu will-change-transform">
      {/* Facebook */}
      <a
        href="https://www.facebook.com/facmedicinaunt"
        target="_blank"
      ...
      {/* Instagram */}
      <a
        href="https://www.instagram.com/fm.unt/"
        target="_blank"
        rel="noopener noreferrer"
        className="w-12 h-12 bg-[#1DA1F2] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 hover:shadow-xl transition duration-300 group"
